...
All Rights Reserved
Copyright (c) 2005-2011 ~ Bernard Gilly
...
--------------------  4.0.18 production release [26 May 2011]  ------------------------
# fixed extra div in tmpl/default.php
# fixed plugin system for alphacontent (Add a new param in the plugin configuration for compatibility with ALphaContent 4.0.15)

--------------------  4.0.17 production release [22 february 2011]  -------------------
# fixed new api for Websnap service
# fixed selectedDirectory var (Itemid)
+ added Spanish language (frontend)

--------------------  4.0.16 production release [15 August 2010]  ---------------------
+ added alternate Read more link if exist
+ added counter page in title page
+ added AlphaUserPoints rule for vote article (ajax rating bar for AlphaContent)
+ added search on author of article
! turkish language updated

--------------------  4.0.15 production release [07 February 2010]  -------------------
# fixed ordering on featured article on frontpage
# fixed auto-publish plugins on install
+ added thumbnail generator (phpThumb)
+ added rounder corner on thumbnail image (require phpThumb enabled)
+ added websites thumbnails by www.artviper.net service
- removed param directory at the end of url article
# fixed page title on article
# fixed alphabetical bar on article
# fixed Joomla pathway on showing article

--------------------  4.0.14 production release [02 January 2010]  -------------------
# fixed count comment
# fixed layout contact
# fixed displaying double quote following the word vote after rating
# fixed system cache to check update new version available
# fixed counter and display on specific selected sections and/or categories in menu params
# fixed core SEF
^ Required to works fine PHP 5 and MySQL 5
