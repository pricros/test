...
if ( $debugInstallSQL ) {
	$app->redirect( 'index.php?option=com_alphacontent','NOTICE: AlphaContent plugin is not successfully installed. Make sure that the plugin directory is writeable' );
} else {
	...
	// CHMOD cache for phpThumb
	chmod (JPATH_SITE.DS.'components'.DS.'com_alphacontent'.DS.'assets'.DS.'phpThumb'.DS.'cache', 0755);
