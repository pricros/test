					...
					<td width="50%" valign="top">
						<table class="admintable">
							<tbody>
								...
								<tr>
									<td width="280" class="key">
										<span class="editlinktip hasTip" title="<?php echo JText::_( 'AC_USE_PHPTHUMB' ); ?>::<?php echo JTEXT::_('AC_USE_PHPTHUMB_DESC'); ?>">
											<?php echo JText::_( 'AC_USE_PHPTHUMB' ); ?>
										</span>
									</td>
									<td>
										<?php echo $this->lists['list_usePhpThumb']; ?>&nbsp;&nbsp;[<a href="../components/com_alphacontent/assets/phpThumb/demo/phpThumb.demo.check.php" target="_blank">Check phpThumb configuration</a>]									</td>
								</tr>								
								<tr>
									<td width="280" class="key">
										<span class="editlinktip hasTip" title="<?php echo JText::_( 'AC_ROUNDED_CORNER' ); ?>::<?php echo JTEXT::_('AC_ROUNDED_CORNER_DESC'); ?>">
											<?php echo JText::_( 'AC_EFFECT' ); ?>
										</span>
									</td>
									<td>
										<?php echo $this->lists['list_effectimage'] ?>
									</td>
								</tr>								
							</tbody>
						</table>							
...
<?php
	echo $this->pane->endPanel();
	echo $this->pane->startPanel(JText::_( 'AC_WEBSITE_THUMBNAIL' ), "config-panel-websnapr" );
?>				
		<fieldset class="adminform">
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'AC_ARTVIPER' ); ?></legend>
				<table class="admintable">
					<tbody>
						<tr>
							<td colspan="2"><?php echo JText::_( 'AC_ARTVIPERDESC' ); ?></td>
						</tr>
						<tr>
							<td width="280" class="key">
								<span class="editlinktip hasTip" title="<?php echo JText::_( 'AC_KEY' ); ?>::<?php echo JTEXT::_('AC_KEY'); ?>">
							...
							<td>
                             <input type="text" name="list_keyartviper" id="list_keyartviper" class="inputbox" size="50" value="<?php echo $this->alphacontent_configuration->list_keyartviper; ?>" />
							</td>
						</tr>		
					</tbody>
				</table>
...
<br /><div align="center"><br />AlphaContent is Free Software released under the <a href="http://www.gnu.org/licenses/gpl-2.0.html" target="_blank">GNU/GPL License</a>. <b><br />AlphaContent &copy; <?php echo $copySite ; ?> - Bernard Gilly - <a href="http://www.alphaplug.com" target="_blank">www.alphaplug.com</a> - All Rights Reserved </div>