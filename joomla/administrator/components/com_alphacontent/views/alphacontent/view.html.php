...
class configurationViewAlphacontent extends JView {
	...
	function edit($tpl = null) {
		...
		$options[] = JHTML::_('select.option', 't', JText::_( 'AC_WEBSNAPR' ) . ' ' . JText::_( 'AC_MICRO' ) . ' (90x70)' );
		...
		$options = array();
		$options[] = JHTML::_('select.option', '0', JText::_( 'AC_NO' ) );
		$options[] = JHTML::_('select.option', '1', JText::_( 'AC_YES' ) );
		$lists['list_usePhpThumb'] = JHTML::_('select.booleanlist','list_usePhpThumb', 1, $this->alphacontent_configuration->list_usePhpThumb );		
		// effects for phpThumb
		$options = array();		
		$options[] = JHTML::_('select.option', 'none', JText::_( 'AC_NONE' ));
		$options[] = JHTML::_('select.option', 'fltr[]=ric|5|5', JText::_( 'AC_ROUNDED_CORNER' )   . ' (5px)' );
		$options[] = JHTML::_('select.option', 'fltr[]=ric|10|10', JText::_( 'AC_ROUNDED_CORNER' ) . ' (10px)');
		$options[] = JHTML::_('select.option', 'fltr[]=ric|12|12', JText::_( 'AC_ROUNDED_CORNER' ) . ' (12px)');
		$options[] = JHTML::_('select.option', 'fltr[]=ric|15|15', JText::_( 'AC_ROUNDED_CORNER' ) . ' (15px)');
		$options[] = JHTML::_('select.option', 'fltr[]=ric|20|20', JText::_( 'AC_ROUNDED_CORNER' ) . ' (20px)');
		$lists['list_effectimage'] = JHTML::_('select.genericlist', $options, 'list_effectimage', 'class="inputbox" size="1"' ,'value', 'text', $this->alphacontent_configuration->list_effectimage );
